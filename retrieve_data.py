...
def get_activities(account_id, start_date=None) -> list[dict]:
    ...
    if start_date:
        #  from last certain (2) days (updates every 24 hours + 1 day delay)
...
#     account_id="12740fda-39c7-4199-b569-c3f8ac982a6c", only_executed=True
# )
...
#     account_id="12740fda-39c7-4199-b569-c3f8ac982a6c", days=30, state="executed"
# )
